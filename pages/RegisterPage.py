...
class RegisterPage(BasePage):
    ...
    def enter_first_name(self, first_name_text):
        self.type_into_element(first_name_text, "first_name_filed_id", self.first_name_filed_id)

    def enter_last_name(self, last_name_text):
        self.type_into_element(last_name_text, "last_name_filed_id", self.last_name_filed_id)
    ...
    def enter_password_confirm(self, password_text):
        self.type_into_element(password_text, "confirm_password_filed_id", self.confirm_password_filed_id)
    ...
    def select_no_radio_button(self):
        self.element_click("no_radio_button_xpath", self.no_radio_button_xpath)
    ...
    def register_an_account(self, first_name_text, last_name_text, email_text, telephone_text, password_text,
        ...
        if yes_or_no.__eq__("no"):
            self.select_no_radio_button()
